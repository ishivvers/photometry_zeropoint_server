...
m.contourf(X.T, Y.T, density_0, latlon=True, cmap=plt.cm.binary)
m.colorbar()
...
m.label_meridians(lons, fontsize=9, vnudge=1,
                  halign='left', hnudge=-1)  # hnudge<0 shifts to right
m.contourf(X.T, Y.T, density_1, latlon=True, cmap=plt.cm.binary)
m.colorbar()
plt.title('Mode 1+2 Coverage')
plt.savefig('mode12.png')
...
m.label_meridians(lons, fontsize=9, vnudge=1,
                  halign='left', hnudge=-1)  # hnudge<0 shifts to right
m.contourf(X.T, Y.T, density_2, latlon=True, cmap=plt.cm.binary)
m.colorbar()
plt.title('Mode 1+2+3 Coverage')
plt.savefig('mode123.png')
